"""
Django settings for evan_django project.
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = "django-insecure-75sm3gifk#8xtjjg6iblx+#ld%eay7qkdk(hn4bgc8x)@4w8h("
...
WSGI_APPLICATION = "evan_django.wsgi.application"
